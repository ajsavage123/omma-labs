...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-[#0a0f1c] bg-opacity-100 overflow-hidden font-sans selection:bg-indigo-500/30">
      
      {/* Animated Background Elements */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-indigo-600/20 blur-[120px] rounded-full animate-pulse blur-[180px]" style={{ animationDuration: '8s' }}></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-blue-600/20 blur-[120px] rounded-full animate-pulse blur-[180px]" style={{ animationDuration: '6s', animationDelay: '2s' }}></div>
      <div className="absolute top-[40%] left-[60%] w-[30%] h-[30%] bg-purple-600/10 blur-[100px] rounded-full animate-pulse" style={{ animationDuration: '10s' }}></div>
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full max-w-md lg:w-[450px]">
          <div className="bg-[#111827]/80 backdrop-blur-xl p-10 rounded-3xl shadow-2xl border border-white/10 relative overflow-hidden">
            {/* Inner subtle glow */}
